...
import { createEnv, type BindingsConfig, type ExecutionContextLike } from "@solcreek/host-runtime";
...
function handleError(server: ViteDevServer, res: ServerResponse, err: unknown): void {
...
function failWithError(res: ServerResponse, status: number, detail: string): void {
