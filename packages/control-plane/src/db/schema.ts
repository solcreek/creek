...
export const project = sqliteTable(
  ...
  (table) => [uniqueIndex("idx_project_org_slug").on(table.organizationId, table.slug)],
);
...
export const repoScan = sqliteTable(
  "repo_scan",
  {
    repoOwner: text("repoOwner").notNull(),
    repoName: text("repoName").notNull(),
...
export const auditIpLog = sqliteTable(
  "audit_ip_log",
  {
  ...
  (table) => [index("idx_audit_ip_log_created").on(table.createdAt)],
);
...
export const projectResourceBinding = sqliteTable(
...
export const buildLog = sqliteTable(
  "build_log",
  {
  ...
  (table) => [index("idx_build_log_status").on(table.status, table.startedAt)],
);
...
export const resourceCleanupQueue = sqliteTable(
  "resource_cleanup_queue",
  {
