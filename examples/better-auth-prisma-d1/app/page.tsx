...
export default function Home() {
  ...
  return (
    <main style={S.main}>
      ...
      <input style={S.in} placeholder="name" value={name} onChange={(e) => setName(e.target.value)} />
      <input style={S.in} placeholder="email" value={email} onChange={(e) => setEmail(e.target.value)} />
      <input style={S.in} type="password" placeholder="password" value={password} onChange={(e) => setPassword(e.target.value)} />
...
const S: Record<string, CSSProperties> = {
  main: { maxWidth: 360, margin: "64px auto", display: "flex", flexDirection: "column", gap: 12, fontFamily: "system-ui" },
